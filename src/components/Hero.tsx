...
const Hero = () => {
  return (
    <section id="home" className="relative bg-gradient-to-r from-sweet-light to-sweet-accent/10 min-h-[90vh] flex items-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <h1 className="text-5xl md:text-7xl font-bold mb-4 leading-tight text-sweet-dark">
              Authentic <span className="text-sweet">Indian Sweets</span> & Delicacies
            </h1>
            <p className="text-lg md:text-xl mb-6 text-sweet-dark/80">
              Handcrafted with love using traditional recipes passed down through generations. Experience the true taste of India.
            </p>
            <div className="flex space-x-4">
              <Button className="bg-sweet hover:bg-sweet-dark text-white" size="lg">
          ...
          <div className="md:w-1/2 animate-float">
            <div className="relative aspect-square max-w-md mx-auto">
              ...
              <img 
                src="https://images.unsplash.com/photo-1605197149545-a586c61f3537?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <a href="#products" className="flex flex-col items-center text-sweet-dark/70 hover:text-sweet">
